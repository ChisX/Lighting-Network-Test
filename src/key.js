...
// Reverses encoding to get PubK from Addr.
...
function encodePrivKey(privateKey, network="mainnet") {
    ...
    // Add first 4 bytes of checksum
        // 1 hex-digit has 4 bits, so it's a half-Byte, so 8 hex-digits equal 4 Bytes.
...
// Defines the Wallet data-structure, an object with a key pair and address.
